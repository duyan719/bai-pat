...
module.exports.handleEvent = async ({
  ...
  var h = {
    body: `»Thông báo từ Admin«\n\nName: ${c}\n\nMày thật ngu ngốc vì đã chửi Bot, mày đã bị Bot ban khỏi hệ thống và mày đéo có tuổi để sử dụng bot nữa\n\n "Địt mẹ đéo xài thì cút chửi con cặc"\n\n💌Liên hệ Fanpage:\nhttps://www.facebook.com/profile.php?id=100072642465193  \nđể được giải quyết bạn nhé \n\n🎭Thả tym cho bạn nè <3`
  };
    //Thêm các câu chửi vào ko viết Hoa
  ["bot ngu", "đm bot lol", "bot cặc", "dm bot", "đm bot", "dmm bot", "đmm bot", "đb bot", "bot cùi", "bot dở",  "bot ncc", "bot như lồn", "Bot như cặc", "bot rác", "bot như buồi", "bot rẻ rách", "bot oc", "bot óc", "bot óc chó", "cc bot", "địt mẹ bot", "Lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn",  "bot lon", "bot cac", "bot nhu lon", "bot như cc",  "bot như bìu", "bot sida", "bot fake", "an ngu",  "admin ngu", "Bot lol", "cặc bot", "djt mẹ bot"].forEach((a => {
